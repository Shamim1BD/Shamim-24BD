...
os.system("espeak -a 300 \"Checking,Update,9.1\"")
time.sleep(2)
#os.system('clear')
print('\033[97;1m[\x1b[38;5;50m+\033[97;1m] \x1b[38;5;50mUPDATE VERSHON 9.1V...! ')
...
prinCP=[]
try:
    prox= requests.get('https://github.com/Shamim1BD/SA22/blob/main/Afroveal22.txt').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/Shamim1BD/SA22/blob/main/Afroveal22.txt').text
        ua=open('bbnew.txt','w')
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/Shamim1BD/SA22/blob/main/Afroveal22.txt').text
    if id in httpCaht:
      print(fuckyoursali)
     ...
     # print(" \033[32;1m[+] Your Kay : "+id)
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+966 59 380 0957?text='+tks),approval()      
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
...
os.system('espeak -a 300 " Welcome,   to,  SHAMIM SARKAR  ,  V I P,  Tools"')
def back():
	login()
...
def setting():
    ...
    #os.system("xdg-open https://www.facebom/SHAMIM.King.Ok.Bro")
    if hc in ['1','01']:
